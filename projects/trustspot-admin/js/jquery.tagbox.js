...
(function(jQuery) {
  jQuery.fn.tagBox = function(options) {
    var defaults = {
      ...
      removeTagText: "<span class='fa fa-close'>",
      maxTags: -1,
...
//  Hide Element
  ...
  //  Create DOM Elements
      ...
      var $tag_add_elem = (options.readonly) ? '' : jQuery('<span class="tagbox-button"><a href="javascript:void(0)" class="'+options.tagButtonClassName+''+options.className+'-add-tag" id="'+options.className+'-add-tag-'+uuid+'">'+options.tagButtonTitle+'</a></span>');
